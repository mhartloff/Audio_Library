...
define(function (require) {
	...
	var DeviceMotion =
	{
		...
		acceleration: new Vector3(),	// Acceleration in 3 axes in m/s2  (not interesting to us?)
		...
		updateMatrices: function () {
			...
			var forwardVec = new Vector3(xForward, yForward, zForward);		// Points out the front of the phone
		
			var outVec = new Vector3(0, 1, 0);	// Points out of the phone
