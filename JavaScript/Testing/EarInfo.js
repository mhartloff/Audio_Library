define(function (require) {
	...
	function EarInfo() {
		...
		this.leftPos = new Vector3(0, 0, 0);		// The position of the left ear (in meters)
		this.rightPos = new Vector3(0, 0, 0);	// The position of the right ear (in meters)
		this.leftDir = new Vector3(-1, 0, 0);	// The direction the left ear is facing, normalized.
		this.rightDir = new Vector3(1, 0, 0);	// The direction the right ear is facing, normalized.
