...
define(function (require) {
	...
	var SpatialSound = require("Testing/SpatialSound");
	var TestSound = require("Testing/TestSound");
	var EchoSound = require("EchoSound");
	...
	// Options:
	//		offset (Vector3):  Position offset from the source position.  For instance, coming from an object's head or feet instead of its center.
